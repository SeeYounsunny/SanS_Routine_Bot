...
| ☀️ 점심 리마인드 (12:00 KST) | 단체방에 오늘 오전까지 입력한 사람별 루틴 한 번 공지 |
...
- **단체방**에는 매일 **08:00** 아침 알림, **12:00** 점심 리마인드(오늘 오전까지 입력한 사람별 루틴 공지), **21:00** 저녁 리마인드가 올라옵니다.

모든 기록은 **그날 루틴**으로 저장되며, 오전/저녁 구분은 "오전 기록"/"저녁 기록"으로만 표시됩니다. **자세한 사용법은 `/help` 를 입력하세요.**
...
| `/help` | 사용법 매뉴얼 표시 |
| `/add` | 오늘 루틴 추가 (1:1에서만. 어제 루틴 있으면 번호 선택지 표시) |
